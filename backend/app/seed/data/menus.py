...
DEFAULT_MENUS = [
    {
        ...
        "children": [
            {"menuType": 0, "title": "menus.pureUser", "name": "SystemUser",
             "path": "/system/user", "component": "system/user/index",
             "icon": "ri:admin-line", "rank": 1},
            {"menuType": 0, "title": "menus.pureRole", "name": "SystemRole",
             "path": "/system/role", "component": "system/role/index",
             "icon": "ri:admin-fill", "rank": 2},
            {"menuType": 0, "title": "menus.pureDept", "name": "SystemDept",
