...
class TestUserUpdate:
    ...
    async def test_update_basic_fields(self, user_session):
        user = User(
            ...
            nickname="Up",
            email="up@test.com",
            password=get_password_hash("old12345678"),
            phone="13800000010",
            remark="old",
        )
...
class TestUserAuthenticate:
    ...
    async def test_authenticate_nonexistent_user(self, user_session):
        ...
        with (
            patch("app.controllers.user.getIpAddress", new_callable=AsyncMock, return_value=""),
            patch(
                "app.controllers.user.getReqSysBro",
                new_callable=AsyncMock,
                return_value=Mock(system="Win", browser="Chrome"),
            ),
        ):
            with pytest.raises(HTTPException) as exc_info:
    ...
    async def test_authenticate_locked_account(self, user_session):
        ...
        user = User(
            ...
            password=get_password_hash("Locked12345"),
            phone="13800000020",
            remark="test",
            status=1,
            is_superuser=False,
    ...
    async def test_authenticate_expired_lock_resets(self, user_session):
        ...
        user = User(
            ...
            nickname="EL",
            email="el@test.com",
            password=get_password_hash("ExpiredLock123"),
            phone="13800000021",
            remark="test",
            status=1,
            is_superuser=False,
    ...
    async def test_authenticate_wrong_password_increments_count(self, user_session):
        ...
        user = User(
            ...
            nickname="F",
            email="fail@test.com",
            password=get_password_hash("Right12345"),
            phone="13800000022",
            remark="test",
            status=1,
            is_superuser=False,
    ...
    async def test_authenticate_superuser_wrong_password(self, user_session):
        ...
        user = User(
            ...
            nickname="SA",
            email="sa@test.com",
            password=get_password_hash("Super12345"),
            phone="13800000024",
            remark="test",
            status=1,
            is_superuser=True,
    ...
    async def test_authenticate_disabled_user(self, user_session):
        ...
        user = User(
            ...
            nickname="DA",
            email="da@test.com",
            password=get_password_hash("Disabled12345"),
            phone="13800000025",
            remark="test",
            status=0,
            is_superuser=False,
...
class TestUserMisc:
    ...
    async def test_get_user_by_email(self, user_session):
        user = User(
            ...
            password=get_password_hash("Find12345"),
            phone="13800000030",
            remark="test",
        )
        user_session.add(user)
    ...
    async def test_unlock_user(self, user_session):
        user = User(
            ...
            nickname="UL",
            email="ul@test.com",
            password=get_password_hash("Unlock12345"),
            phone="13800000031",
            remark="test",
    ...
    async def test_update_last_login(self, user_session):
        user = User(
            ...
            nickname="LL",
            email="ll@test.com",
            password=get_password_hash("Last12345"),
            phone="13800000032",
            remark="test",
        )
        user_session.add(user)
