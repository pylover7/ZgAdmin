...
class TestFileListAPI:
    def test_list_files(self, client, admin_headers, db, admin_user):
        ...
        file_obj = File(
            name="list_test.jpg",
            path="uploads/test/list_test.jpg",
            size=1024,
    ...
    def test_list_files_with_name_filter(self, client, admin_headers, db, admin_user):
        file_obj = File(
            name="unique_search_name.pdf",
            path="uploads/test/search.pdf",
            size=2048,
    ...
    def test_list_files_with_type_filter(self, client, admin_headers, db, admin_user):
        file_obj = File(
            name="type_filter.mp3",
            path="uploads/test/filter.mp3",
            size=4096,
...
class TestFileDeleteAPI:
    def test_delete_file(self, client, admin_headers, db, admin_user):
        file_obj = File(
            name="del_target.jpg",
            path="uploads/test/del_target.jpg",
            size=256,
            mime_type="image/jpeg",
            file_type="image",
            extension="jpg",
